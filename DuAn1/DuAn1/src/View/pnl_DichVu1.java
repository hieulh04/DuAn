 ...
 * @author LE HUU HIEU
 */
public class pnl_DichVu1 extends javax.swing.JPanel {

    private IDichVu_service iDichVu_service;
    public static pnl_DichVu1 formDichVu;

    /**
     * Creates new form pnl_DichVu1
     */
    public pnl_DichVu1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblDichVu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã DV", "Tên DV", "Số lượng", "Giá bán", "Đơn vị", "Danh mục"
            }
        ) {
    ...
    private void tblDichVuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDichVuMouseClicked
        ...
        String danhmuc = this.tblDichVu.getValueAt(row, 6).toString();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // TODO add your handling code here:
        DichVu_Model dv = iDichVu_service.getDVByMa(txtMaDV.getText());
        if (dv != null) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        DichVu_Model dv = this.getFormData();
        if (dv == null) {
            return;
        }
...
public DichVu_Model getFormData() {
        DichVu_Model dv = new DichVu_Model();
        ...
        if (ma.trim().length() == 0
                || ten.trim().length() == 0
                || txtSoLuong.getText().trim().length() == 0
